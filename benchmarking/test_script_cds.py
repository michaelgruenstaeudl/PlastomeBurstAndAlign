...
folder_CDS = os.path.join(main_folder, dataset + "_output_CDS")
...
dirs_to_create = [
    folder_CDS,
    os.path.join(folder_CDS, "01_unalign"),
    os.path.join(folder_CDS, "02_aligned"),
    os.path.join(folder_CDS, "02_aligned", "fasta"),
    os.path.join(folder_CDS, "02_aligned", "nexus"),
]
...
subprocess.run([
    ...
    "-i", main_folder, "-o", folder_CDS,
    "-s", "cds", "-t", "5", "-l", "6", "-n", nCPUs
], check=True)
run_end = time.time()
...
move_files(os.path.join(folder_CDS, "*.unalign.fasta"), os.path.join(folder_CDS, "01_unalign"))
move_files(os.path.join(folder_CDS, "*.aligned.fasta"), os.path.join(folder_CDS, "02_aligned", "fasta"))
move_files(os.path.join(folder_CDS, "*.aligned.nexus"), os.path.join(folder_CDS, "02_aligned", "nexus"))
