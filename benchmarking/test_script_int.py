...
subprocess.run(["mv"] + glob.glob(f"{folder_INT}/*.unalign.fasta") + [f"{folder_INT}/01_unalign/"])
subprocess.run(["mv"] + glob.glob(f"{folder_INT}/*.aligned.fasta") + [f"{folder_INT}/02_aligned/fasta/"])
subprocess.run(["mv"] + glob.glob(f"{folder_INT}/*.aligned.nexus") + [f"{folder_INT}/02_aligned/nexus/"])
